# Generated by Powerlevel10k configuration wizard on 2026-06-06 at 14:41 +05.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%79F'   # poimandres teal
      local   modified='%222F'  # poimandres yellow
      local  untracked='%117F'  # poimandres blue
      local conflicted='%210F'  # poimandres soft red
    else
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=79
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=141
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=75
  # Custom icon.
